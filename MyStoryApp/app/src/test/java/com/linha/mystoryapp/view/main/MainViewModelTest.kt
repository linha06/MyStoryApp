...
import com.linha.mystoryapp.DataDummy
import com.linha.mystoryapp.MainDispatcherRule
...
import com.linha.mystoryapp.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        if (::storyRepository.isInitialized && ::userRepository.isInitialized) {
            val mainViewModel = MainViewModel(userRepository, storyRepository)
            expectedStory.value = data

            mainViewModel.getSession().observe(coroutineContext as LifecycleOwner){
                token = it.token
            }
